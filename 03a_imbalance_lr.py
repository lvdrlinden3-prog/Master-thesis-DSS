...
# ─────────────────────────────────────────────
# STEP 3a.1 — Load data (same canonical split as Script 02)
# ─────────────────────────────────────────────
print("=" * 60)
print("STEP 3a.1 — Setup (canonical temporal split 2012–2024)")
print("=" * 60)
...
# ─────────────────────────────────────────────
# STEP 3a.2 — SMOTE sensitivity scan → select best sampling_strategy
# ─────────────────────────────────────────────
print("\n" + "=" * 60)
print("STEP 3a.2 — SMOTE sensitivity scan (select best sampling_strategy)")
print("=" * 60)
...
# ─────────────────────────────────────────────
# STEP 3a.3 — Five strategies (built with best_ss)
# ─────────────────────────────────────────────
print("\n" + "=" * 60)
print(f"STEP 3a.3 — Five imbalance-handling strategies (ss={best_ss:.2f})")
print("=" * 60)
...
# ─────────────────────────────────────────────
# STEP 3a.4 — Select winning strategy
# ─────────────────────────────────────────────
print("\n" + "=" * 60)
print("STEP 3a.4 — Winner selection (argmax Val PR-AUC)")
print("=" * 60)
...
comp_df.to_csv('outputs/table_08a_imbalance_lr.csv', index=False)
print("\nTable 08a saved: outputs/table_08a_imbalance_lr.csv")
...
# ─────────────────────────────────────────────
# STEP 3a.5 — Figure 09a
# ─────────────────────────────────────────────
print("\n" + "=" * 60)
print("STEP 3a.5 — Figure 09a: Four-panel comparison")
print("=" * 60)
...
plt.tight_layout()
plt.savefig('outputs/fig_09a_imbalance_lr.png', dpi=300, bbox_inches='tight')
plt.close()
print("Figure 09a saved: outputs/fig_09a_imbalance_lr.png")
...
with open('outputs/selected_imbalance_strategy_lr.txt', 'w') as f:
...
print("Selected strategy saved: outputs/selected_imbalance_strategy_lr.txt")

print("\n=== Script 03a complete. All outputs saved to outputs/ ===")
print(f"\nSummary:")
...
print(f"\n  This strategy will be applied to LR in Script 04.")
